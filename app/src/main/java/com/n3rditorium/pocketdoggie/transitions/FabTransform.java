...
package com.n3rditorium.pocketdoggie.transitions;
 ...
 * <p/>
 * See: https://www.google.com/design/spec/motion/transforming-material
 * .html#transforming-material-radial-transformation
 */
public class FabTransform extends Transition {
   ...
   public static boolean setup(@NonNull Activity activity, @Nullable View target) {
      ...
      activity.getWindow()
            .setSharedElementEnterTransition(sharedEnter);
      return true;
   }
   ...
   public Animator createAnimator(final ViewGroup sceneRoot, final TransitionValues startValues,
      ...
      final Drawable fabIcon = ContextCompat.getDrawable(sceneRoot.getContext(), icon)
            .mutate();
